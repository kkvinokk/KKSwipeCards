...
Pod::Spec.new do |s|
  s.name             = 'KKSwipeCards'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KKSwipeCards.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Vinoth Anandan/KKSwipeCards'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vinoth Anandan' => 'kkvinokk@gmail.com' }
  s.source           = { :git => 'https://github.com/Vinoth Anandan/KKSwipeCards.git', :tag => s.version.to_s }
